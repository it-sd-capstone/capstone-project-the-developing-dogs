...
* .NET SDK (included with Unity/Visual Studio)
...
3. Click **"Add" → "Add project from disk"** and select the cloned project folder.
...
This project is validated using manual testing and stub functions.

### Test 1: Project Startup
